...
| [dashboard.md](./dashboard.md)           | Dashboard route/feature; server lists → copy `members-table.tsx` |
...
| Server list    | `apps/web/src/app/dashboard/(organization)/manage/members/components/members-table.tsx` (+ `members-columns.tsx`) |
